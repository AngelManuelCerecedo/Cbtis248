        ...
        <div class="w-full rounded p-8 sm:p-12 ">
            ...
            <div class="md:flex items-center mt-8">
                ...
                <div class="w-full md:w-1/4 flex flex-col ml-10">
                    ...
                    <select wire:model='M'
                        ...
                        @foreach ($materias as $materia)
                            <option value="{{ $materia->id }}">{{ $materia->Nombre }} Prof: ({{$materia->profesor->Nombre}})</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class=" flex flex-col md:ml-80">
                    <button
                        class="mt-8 ml-96 font-sans leading-none text-white py-3 px-28 bg-[#78163B] rounded hover:bg-[#78163B] focus:ring-2 focus:ring-offset-2 focus:ring-[#78163B] focus:outline-none"
                        wire:click="añadir()">
                        Añadir
                    </button>
                </div>
