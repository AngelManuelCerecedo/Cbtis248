<div>
    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="pt-8">
                <h1 class="text-4xl font-sans leading-tight text-center">INCIDENCIAS DE GRUPOS</h1>
            </div>
            <!--DIV PADRE-->
                                    ...
                                    @if ($grupo->Clave_Grupo != 'Sin Grupo')
                                        <tr>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{{ $grupo->Clave_Grupo }}
                                                </p>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">

                                                <button wire:click='crearmodal({{ $grupo->id }})' type="button"
                                                    class="text-white border bg-[#4eb553] rounded-lg  text-sm  ml-10 py-2 px-6 m-1">Registrar</button>

                                                <br>

                                                <a href="{{ route('LincidenciasG', [$grupo->id]) }}">
                                                    <button type="button"
