<div>
    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="pt-8">
                <h1 class="text-4xl font-sans leading-tight text-center">INCIDENCIAS DEL ALUMNO</h1>
                <br>
                <h1 class="text-4xl font-sans leading-tight text-center uppercase">{{ $alumno->Nombre }}
                    {{ $alumno->ApPaterno }} {{ $alumno->ApMaterno }}</h1>
            </div>
            <!--DIV PADRE-->
